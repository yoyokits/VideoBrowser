namespace VideoBrowser.Test.Views
{
    ...
    public class UrlEditorViewTest
    {
        ...
        public void Show_UrlEditorView()
        {
            ...
            var viewModelA = new UrlEditorViewModel(urlReader, globalBrowserData) { IsVisible = true, FileName = "Youtube Video File Name", FileSize = "5 MB", Duration = "00:02:45" };
            var viewModelB = new UrlEditorViewModel(urlReader, globalBrowserData) { IsVisible = true, FileName = "Youtube Video File Name", FileSize = "1.4 MB", Duration = "00:02:45", IsBusy = true };
